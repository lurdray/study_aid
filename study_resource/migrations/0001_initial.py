    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributor', models.CharField(default='Anonymous', max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('contributor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_user.appuser')),
            ],
        ),
        migrations.CreateModel(
            name='Content',
        ...
        migrations.CreateModel(
            name='StudyResourceChatConnector',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pub_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study_resource.chat')),
                ('study_resource', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study_resource.studyresource')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='studyresource',
            name='chats',
            field=models.ManyToManyField(through='study_resource.StudyResourceChatConnector', to='study_resource.Chat'),
        ),
        migrations.AddField(
            model_name='studyresource',
            name='contents',
